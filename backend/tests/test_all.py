...
class TestAuthentication:
    ...
    def test_verify_token(self):
        ...
        token = create_access_token(
            {"sub": "123", "telegram_id": 456, "username": "testuser"}
        )
    ...
    def test_expired_token(self):
        ...
        token = create_access_token(
            {"sub": "123", "telegram_id": 456}, expires_delta=timedelta(seconds=-1)
        )
...
class TestBackupSystem:
    ...
    def test_backup_config(self):
        ...
        config = BackupConfig(backup_dir="./test_backups", max_backups=5, compress=True)
...
class TestLogging:
    ...
    def test_audit_logging(self):
        ...
        # Should not raise
        log_audit_event(event_type="auth", user_id=123, action="login", success=True)
